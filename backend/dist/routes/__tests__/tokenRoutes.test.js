...
const mockedTokenManager = tokenManager_1.tokenManager;
describe("Token Routes", () => {
    let app;
    beforeEach(() => {
        app = (0, express_1.default)();
        app.use(express_1.default.json());
        app.use("/tokens", tokenRoutes_1.tokenRoutes);
        jest.clearAllMocks();
    });
    describe("GET /tokens/validate-all", () => {
        it("should validate all tokens for user", async () => {
            ...
            const response = await (0, supertest_1.default)(app).get("/tokens/validate-all").expect(200);
        ...
        it("should handle validation errors", async () => {
            ...
            const response = await (0, supertest_1.default)(app).get("/tokens/validate-all").expect(500);
    ...
    describe("POST /tokens/refresh-expiring", () => {
        it("should refresh expiring tokens", async () => {
            ...
            const response = await (0, supertest_1.default)(app).post("/tokens/refresh-expiring").expect(200);
            expect(response.body.userId).toBe("user-123");
        ...
        it("should handle refresh errors", async () => {
            ...
            const response = await (0, supertest_1.default)(app).post("/tokens/refresh-expiring").expect(500);
    ...
    describe("GET /tokens/valid/:platform", () => {
        it("should return valid token status for platform", async () => {
            ...
            const response = await (0, supertest_1.default)(app).get("/tokens/valid/youtube").expect(200);
            ...
            expect(response.body.timestamp).toBeDefined();
            expect(mockedTokenManager.getValidToken).toHaveBeenCalledWith("user-123", client_1.Platform.YOUTUBE);
        });
        it("should return 404 if no valid token available", async () => {
            mockedTokenManager.getValidToken.mockResolvedValue(null);
            const response = await (0, supertest_1.default)(app).get("/tokens/valid/youtube").expect(404);
        ...
        it("should return 400 for invalid platform", async () => {
            const response = await (0, supertest_1.default)(app).get("/tokens/valid/invalid-platform").expect(400);
        ...
        it("should return 401 for token refresh failure", async () => {
            ...
            const response = await (0, supertest_1.default)(app).get("/tokens/valid/youtube").expect(401);
    ...
    describe("GET /tokens/health", () => {
        it("should return token health summary", async () => {
            ...
            mockedTokenManager.validateAllTokens.mockResolvedValue(mockResults);
            const response = await (0, supertest_1.default)(app).get("/tokens/health").expect(200);
            expect(response.body.userId).toBe("user-123");
        ...
        it("should handle health check errors", async () => {
            ...
            const response = await (0, supertest_1.default)(app).get("/tokens/health").expect(500);
    ...
    describe("POST /tokens/cleanup-expired", () => {
        it("should cleanup expired tokens", async () => {
            ...
            const response = await (0, supertest_1.default)(app).post("/tokens/cleanup-expired").expect(200);
        ...
        it("should handle cleanup errors", async () => {
            ...
            const response = await (0, supertest_1.default)(app).post("/tokens/cleanup-expired").expect(500);
