...
describe("Auth Routes", () => {
    ...
    describe("POST /auth/register", () => {
        it("should register a new user successfully", async () => {
            ...
            const response = await (0, supertest_1.default)(app).post("/auth/register").send(userData).expect(201);
        ...
        it("should return 400 for invalid email", async () => {
            ...
            const response = await (0, supertest_1.default)(app).post("/auth/register").send(userData).expect(400);
        ...
        it("should return 409 for existing user", async () => {
            ...
            const response = await (0, supertest_1.default)(app).post("/auth/register").send(userData).expect(409);
    ...
    describe("POST /auth/login", () => {
        it("should login user successfully", async () => {
            ...
            const response = await (0, supertest_1.default)(app).post("/auth/login").send(loginData).expect(200);
        ...
        it("should return 401 for invalid credentials", async () => {
            ...
            const response = await (0, supertest_1.default)(app).post("/auth/login").send(loginData).expect(401);
    ...
    describe("POST /auth/logout", () => {
        it("should logout user successfully", async () => {
            ...
            const response = await (0, supertest_1.default)(app).post("/auth/logout").expect(200);
    ...
    describe("GET /auth/profile", () => {
        it("should get user profile successfully", async () => {
            ...
            const response = await (0, supertest_1.default)(app).get("/auth/profile").expect(200);
    ...
    describe("PUT /auth/profile", () => {
        it("should update user profile successfully", async () => {
            ...
            const response = await (0, supertest_1.default)(app).put("/auth/profile").send(updateData).expect(200);
    ...
    describe("PUT /auth/change-password", () => {
        it("should change password successfully", async () => {
            ...
            const response = await (0, supertest_1.default)(app).put("/auth/change-password").send(passwordData).expect(200);
        ...
        it("should return 400 for weak new password", async () => {
            ...
            const response = await (0, supertest_1.default)(app).put("/auth/change-password").send(passwordData).expect(400);
            expect(response.body.error).toBe("Validation failed");
        });
    });
    describe("GET /auth/verify", () => {
        it("should verify token successfully", async () => {
            const response = await (0, supertest_1.default)(app).get("/auth/verify").expect(200);
