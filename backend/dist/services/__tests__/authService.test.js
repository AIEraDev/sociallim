...
database_1.prisma.user = mockPrisma.user;
database_1.prisma.userSession = mockUserSession;
...
describe("AuthService", () => {
    ...
    describe("register", () => {
        ...
        it("should throw error if user already exists", async () => {
            ...
            await expect(authService_1.AuthService.register(registerData)).rejects.toThrow("User with this email already exists");
        });
    });
    describe("login", () => {
        const loginData = {
        ...
        it("should throw error for invalid email", async () => {
            mockPrisma.user.findUnique.mockResolvedValue(null);
            await expect(authService_1.AuthService.login(loginData)).rejects.toThrow("Invalid email or password");
        });
    ...
    describe("verifyToken", () => {
        it("should verify valid token successfully", async () => {
            ...
            expect(mockUserSession.findUnique).toHaveBeenCalledWith(expect.objectContaining({
                where: { token },
    ...
    describe("validatePassword", () => {
        it("should validate strong password", () => {
            const result = authService_1.AuthService.validatePassword("StrongPass123!");
        ...
        it("should reject weak passwords", () => {
            ...
            testCases.forEach(({ password, expectedErrors }) => {
                const result = authService_1.AuthService.validatePassword(password);
    ...
    describe("updateProfile", () => {
        it("should update user profile successfully", async () => {
            ...
            const result = await authService_1.AuthService.updateProfile(userId, updateData);
        ...
        it("should throw error if email is already taken", async () => {
            ...
            await expect(authService_1.AuthService.updateProfile(userId, updateData)).rejects.toThrow("Email is already taken");
        });
    });
    describe("changePassword", () => {
        ...
        it("should throw error for incorrect current password", async () => {
            ...
            mockPrisma.user.findUnique.mockResolvedValue(mockUser);
            mockBcrypt.compare.mockResolvedValue(false);
            await expect(authService_1.AuthService.changePassword(userId, currentPassword, newPassword)).rejects.toThrow("Current password is incorrect");
        });
    });
});
